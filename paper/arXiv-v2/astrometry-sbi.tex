...
SM warmly thanks Kyle Cranmer, Cristina Mondino, Tess Smidt, Ken Van Tilburg, and Neal Weiner for helpful conversations. SM benefitted from the hospitality of the Center for Computational Astrophysics at the Flatiron Institute while this work was being performed. 
...
We acknowledge the use of the \deepsphere graph convolutional layer implementation as well as code used to produce elements of Fig.~\ref{fig:model} from the code repository associated with \citet{2020arXiv201215000D} (\url{https://github.com/deepsphere/deepsphere-pytorch}).
\end{acknowledgments}
...
\section{{Additional details on the forward model}}
